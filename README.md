...
### Windows
 - 初次使用安装 [Chrome](https://www.google.cn/intl/zh-CN/chrome)
 - 下载解锁[文件](https://github.com/morckclient/apple-id-unlock/releases/download/v20221114/maiu_windows_v1.0.4_debug.zip)  
 - 解压缩后使用命令提示行 `cmd` 运行
